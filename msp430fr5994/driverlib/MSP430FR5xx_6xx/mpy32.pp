...
{
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x002C)))) &= ~((0x0200) + (0x0100));
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x002C)))) |= writeDelaySelect;
}

void MPY32_enableSaturationMode(void)
{
    (*((volatile uint8_t *)((uint16_t)0x04C0 + (0x002C)))) |= (0x0008);
}
...
{
    return ((*((volatile uint8_t *)((uint16_t)0x04C0 + (0x002C)))) & ((0x0008)));
}

void MPY32_enableFractionalMode(void)
{
    (*((volatile uint8_t *)((uint16_t)0x04C0 + (0x002C)))) |= (0x0004);
}
...
{
    return ((*((volatile uint8_t *)((uint16_t)0x04C0 + (0x002C)))) & ((0x0004)));
}

void MPY32_setOperandOne8Bit(uint8_t multiplicationType,
                             uint8_t operand)
{
    (*((volatile uint8_t *)((uint16_t)0x04C0 + (0x0000) + multiplicationType))) = operand;
}

void MPY32_setOperandOne16Bit(uint8_t multiplicationType,
                              uint16_t operand)
{
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x0000) + multiplicationType))) = operand;
}
                              ...
                              uint32_t operand)
{
    ...
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x0010) + multiplicationType))) = operand;
    (*((volatile uint8_t *)((uint16_t)0x04C0 + (0x0012) + multiplicationType))) = (operand >> 16);
}
                              ...
                              uint32_t operand)
{
    multiplicationType <<= 1;
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x0010) + multiplicationType))) = operand;
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x0012) + multiplicationType))) = (operand >> 16);
}

void MPY32_setOperandTwo8Bit(uint8_t operand)
{
    (*((volatile uint8_t *)((uint16_t)0x04C0 + (0x0008)))) = operand;
}

void MPY32_setOperandTwo16Bit(uint16_t operand)
{
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x0008)))) = operand;
}

void MPY32_setOperandTwo24Bit(uint32_t operand)
{
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x0020)))) = operand;
    (*((volatile uint8_t *)((uint16_t)0x04C0 + (0x0022)))) = (operand >> 16);
}

void MPY32_setOperandTwo32Bit(uint32_t operand)
{
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x0020)))) = operand;
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x0022)))) = (operand >> 16);
}
...
uint64_t MPY32_getResult(void)
{
    ...
    result = (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x0024))));
    result += ((uint64_t)(*((volatile uint16_t *)((uint16_t)0x04C0 + (0x0026)))) << 16);
    result += ((uint64_t)(*((volatile uint16_t *)((uint16_t)0x04C0 + (0x0028)))) << 32);
    result += ((uint64_t)(*((volatile uint16_t *)((uint16_t)0x04C0 + (0x002A)))) << 48);
    return (result);
}

uint16_t MPY32_getSumExtension(void)
{
    return ((*((volatile uint16_t *)((uint16_t)0x04C0 + (0x000E)))));
}

uint16_t MPY32_getCarryBitValue(void)
{
    return ((*((volatile uint16_t *)((uint16_t)0x04C0 + (0x002C)))) | (0x0001));
}

void MPY32_clearCarryBitValue(void)
{
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x002C)))) &= ~(0x0001);
}

void MPY32_preloadResult(uint64_t result)
{
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x0024)))) = (result & 0xFFFF);
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x0026)))) = ((result >> 16) & 0xFFFF);
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x0028)))) = ((result >> 32) & 0xFFFF);
    (*((volatile uint16_t *)((uint16_t)0x04C0 + (0x002A)))) = ((result >> 48) & 0xFFFF);
}
