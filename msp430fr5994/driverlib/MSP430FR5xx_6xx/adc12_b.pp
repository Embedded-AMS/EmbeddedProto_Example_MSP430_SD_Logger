...
_Bool ADC12_B_init(uint16_t baseAddress,
                  ADC12_B_initParam *param)
{
    
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)))) &= ~(0x0002);

    _Bool retVal = 0x01;

    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~((0x0010) + (0x0002) + (0x0001));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0012)))) &= 0x0000;  
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0014)))) &= 0x0000;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0016)))) &= 0x0000;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000C)))) &= 0x0000;  
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000E)))) &= 0x0000;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0010)))) &= 0x0000;

    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) =
        param->sampleHoldSignalSourceSelect 
        + (param->clockSourceDivider & (0x00e0)) 
        + (param->clockSourcePredivider & (0x6000))
...
void ADC12_B_enable(uint16_t baseAddress)
{
    ...
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x0010);
}
                                ...
                                uint16_t multipleSamplesEnabled)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &=
        ~((0x0f00) + (0xf000) + (0x0080));

    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= clockCycleHoldCountLowMem
                             ...
                             ADC12_B_configureMemoryParam *param)
{
    ...
    if(!((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) & (0x0002)))
    {
        ...
        uint16_t memoryBufferControlOffset =
            ((0x0020) + param->memoryBufferControlIndex);

        
        (*((volatile uint16_t *)((uint16_t)baseAddress + memoryBufferControlOffset))) =
            param->inputSourceSelect 
            + param->refVoltageSourceSelect 
            + param->endOfSequence; 
...
void ADC12_B_setWindowCompAdvanced(uint16_t baseAddress,
                                   ...
                                   uint16_t lowThreshold)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000A)))) = highThreshold;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) = lowThreshold;
}
...
void ADC12_B_enableInterrupt(uint16_t baseAddress,
                             ...
                             uint16_t interruptMask2)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0012)))) |= interruptMask0;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0014)))) |= interruptMask1;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0016)))) |= interruptMask2;
}
...
void ADC12_B_clearInterrupt(uint16_t baseAddress,
                            ...
                            uint16_t memoryInterruptFlagMask)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000C) + 2 * interruptRegisterChoice))) &=
...
uint16_t ADC12_B_getInterruptStatus(uint16_t baseAddress,
                                    ...
                                    uint16_t memoryInterruptFlagMask)
{
    return ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x000C) + 2 * interruptRegisterChoice)))
            & memoryInterruptFlagMask);
}
                             ...
                             uint8_t conversionSequenceModeSelect)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) &= ~((0x001f));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) &= ~((0x0006));

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) |= startingMemoryBufferIndex;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) |= conversionSequenceModeSelect;
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x0002) + (0x0001);
}
                                ...
                                _Bool preempt)
{
    if(1 == preempt)
    {
        (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0002)))) &= ~((0x0006));
        
    }
    else if(~((*((volatile uint8_t *)((uint16_t)baseAddress + (0x0002)))) & (0x0006)))
    {
...
uint16_t ADC12_B_getResults(uint16_t baseAddress,
                            uint8_t memoryBufferIndex)
{
    return ((*((volatile uint16_t *)((uint16_t)baseAddress + ((0x0060) + memoryBufferIndex)))));
...
void ADC12_B_setResolution(uint16_t baseAddress,
                           uint8_t resolutionSelect)
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0004)))) &= ~((0x0030));
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0004)))) |= resolutionSelect;
}
...
void ADC12_B_setDataReadBackFormat(uint16_t baseAddress,
                                   uint8_t readBackFormat)
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0004)))) &= ~((0x0008));
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0004)))) |= readBackFormat;
}

void ADC12_B_setAdcPowerMode(uint16_t baseAddress,
                             uint8_t powerMode)
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0004)))) &= ~((0x0001));
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0004)))) |= powerMode;
}

uint32_t ADC12_B_getMemoryAddressForDMA(uint16_t baseAddress,
                                        uint8_t memoryIndex)
{
    return (baseAddress + ((0x0060) + memoryIndex));
    
}

uint8_t ADC12_B_isBusy(uint16_t baseAddress)
{
    return ((*((volatile uint8_t *)((uint16_t)baseAddress + (0x0002)))) & (0x0001));
}
