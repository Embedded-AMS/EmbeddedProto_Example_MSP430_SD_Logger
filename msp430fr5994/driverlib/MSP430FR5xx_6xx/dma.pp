...
void DMA_init(DMA_initParam *param){
    ...
    (*((volatile uint16_t *)((uint16_t)0x0500 + param->channelSelect + (0x0010)))) =
        param->transferModeSelect 
        + param->transferUnitSelect 
        + param->triggerTypeSelect; 

    
    (*((volatile uint16_t *)((uint16_t)0x0500 + param->channelSelect + (0x001A)))) = param->transferSize;

    if(triggerOffset & 0x01)     
    {
        (*((volatile uint16_t *)((uint16_t)0x0500 + (triggerOffset & 0x0E)))) &= 0x00FF; 
        (*((volatile uint16_t *)((uint16_t)0x0500 + (triggerOffset & 0x0E)))) |= (param->triggerSourceSelect << 8);
    }
    else       
    {
        (*((volatile uint16_t *)((uint16_t)0x0500 + (triggerOffset & 0x0E)))) &= 0xFF00; 
        (*((volatile uint16_t *)((uint16_t)0x0500 + (triggerOffset & 0x0E)))) |= param->triggerSourceSelect;
    }
}
                         ...
                         uint16_t transferSize)
{
    ...
    (*((volatile uint16_t *)((uint16_t)0x0500 + channelSelect + (0x001A)))) = transferSize;
}

uint16_t DMA_getTransferSize(uint8_t channelSelect)
{
    
    return((*((volatile uint16_t *)((uint16_t)0x0500 + channelSelect + (0x001A)))));
}
                       ...
                       uint16_t directionSelect)
{
    ...
    __data16_write_addr((unsigned short)(0x0500 + channelSelect + (0x0012)),
                        srcAddress);

    
    (*((volatile uint16_t *)((uint16_t)0x0500 + channelSelect + (0x0010)))) &= ~((0x0300));
    (*((volatile uint16_t *)((uint16_t)0x0500 + channelSelect + (0x0010)))) |= directionSelect;
}
                       ...
                       uint16_t directionSelect)
{
    ...
    __data16_write_addr((unsigned short)(0x0500 + channelSelect + (0x0016)),
                        dstAddress);

    
    (*((volatile uint16_t *)((uint16_t)0x0500 + channelSelect + (0x0010)))) &= ~((0x0c00));
    (*((volatile uint16_t *)((uint16_t)0x0500 + channelSelect + (0x0010)))) |= (directionSelect << 2);
}

void DMA_enableTransfers(uint8_t channelSelect)
{
    (*((volatile uint16_t *)((uint16_t)0x0500 + channelSelect + (0x0010)))) |= (0x0010);
}
...
{
    (*((volatile uint16_t *)((uint16_t)0x0500 + channelSelect + (0x0010)))) |= (0x0001);
}

void DMA_enableInterrupt(uint8_t channelSelect)
{
    (*((volatile uint16_t *)((uint16_t)0x0500 + channelSelect + (0x0010)))) |= (0x0004);
}
...
{
    return ((*((volatile uint16_t *)((uint16_t)0x0500 + channelSelect + (0x0010)))) & (0x0008));
}

void DMA_clearInterrupt(uint8_t channelSelect)
{
    (*((volatile uint16_t *)((uint16_t)0x0500 + channelSelect + (0x0010)))) &= ~((0x0008));
}

uint16_t DMA_getNMIAbortStatus(uint8_t channelSelect)
{
    return ((*((volatile uint16_t *)((uint16_t)0x0500 + channelSelect + (0x0010)))) & (0x0002));
}

void DMA_clearNMIAbort(uint8_t channelSelect)
{
    (*((volatile uint16_t *)((uint16_t)0x0500 + channelSelect + (0x0010)))) &= ~((0x0002));
}

void DMA_disableTransferDuringReadModifyWrite(void)
{
    (*((volatile uint16_t *)((uint16_t)0x0500 + (0x0008)))) |= (0x0004);
}
...
{
    (*((volatile uint16_t *)((uint16_t)0x0500 + (0x0008)))) |= (0x0002);
}
...
{
    (*((volatile uint16_t *)((uint16_t)0x0500 + (0x0008)))) |= (0x0001);
}
