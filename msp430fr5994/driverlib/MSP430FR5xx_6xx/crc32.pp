                   ...
                   uint8_t crcMode)
{
    if((0x00) == crcMode)
    {
        (*((volatile uint16_t *)((uint16_t)0x0980 + (0x0018)))) = seed;
    }
    else
    {
        (*((volatile uint16_t *)((uint16_t)0x0980 + (0x000A)))) = ((seed & 0xFFFF0000)
                                                   >> 16);
        (*((volatile uint16_t *)((uint16_t)0x0980 + (0x0008)))) = (seed & 0xFFFF);
    }
}
                       ...
                       uint8_t crcMode)
{
    if((0x00) == crcMode)
    {
        (*((volatile uint8_t *)((uint16_t)0x0980 + (0x0010)))) = dataIn;
    }
    else
    {
        (*((volatile uint8_t *)((uint16_t)0x0980 + (0x0000)))) = dataIn;
    }
}
                        ...
                        uint8_t crcMode)
{
    if((0x00) == crcMode)
    {
        (*((volatile uint16_t *)((uint16_t)0x0980 + (0x0010)))) = dataIn;
    }
    else
    {
        (*((volatile uint16_t *)((uint16_t)0x0980 + (0x0000)))) = dataIn;
    }
}

void CRC32_set32BitData(uint32_t dataIn)
{
    (*((volatile uint16_t *)((uint16_t)0x0980 + (0x0000)))) = dataIn & 0xFFFF;
    (*((volatile uint16_t *)((uint16_t)0x0980 + (0x0002)))) = (uint16_t) ((dataIn & 0xFFFF0000)
                                                      >> 16);
}
                               ...
                               uint8_t crcMode)
{
    if((0x00) == crcMode)
    {
        (*((volatile uint8_t *)((uint16_t)0x0980 + (0x0016)))) = dataIn;
    }
    else
    {
        (*((volatile uint8_t *)((uint16_t)0x0980 + (0x0004)))) = dataIn;
    }
}
                                ...
                                uint8_t crcMode)
{
    if((0x00) == crcMode)
    {
        (*((volatile uint16_t *)((uint16_t)0x0980 + (0x0016)))) = dataIn;
    }
    else
    {
        (*((volatile uint16_t *)((uint16_t)0x0980 + (0x0004)))) = dataIn;
    }
}

void CRC32_set32BitDataReversed(uint32_t dataIn)
{
    (*((volatile uint16_t *)((uint16_t)0x0980 + (0x0004)))) = dataIn & 0xFFFF;
    (*((volatile uint16_t *)((uint16_t)0x0980 + (0x0006)))) = (uint16_t) ((dataIn & 0xFFFF0000)
                                                        >> 16);
}
...
uint32_t CRC32_getResult(uint8_t crcMode)
{
    if((0x00) == crcMode)
    {
        return ((*((volatile uint16_t *)((uint16_t)0x0980 + (0x0018)))));
    }
    else
    {
        uint32_t result = 0;
        result = (*((volatile uint16_t *)((uint16_t)0x0980 + (0x000A))));
        result = (result << 16);
        result |= (*((volatile uint16_t *)((uint16_t)0x0980 + (0x0008))));
        return (result);
    }
}
...
uint32_t CRC32_getResultReversed(uint8_t crcMode)
{
    if((0x00) == crcMode)
    {
        return ((*((volatile uint16_t *)((uint16_t)0x0980 + (0x001E)))));
    }
    else
    {
        uint32_t result = 0;
        result = (*((volatile uint16_t *)((uint16_t)0x0980 + (0x000E))));
        result = (result << 16);
        result |= (*((volatile uint16_t *)((uint16_t)0x0980 + (0x000C))));
        return (result);
    }
}
