                            ...
                            uint16_t keyLength)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= (~((0x0004) + (0x0008)));
    ...
    for(i = 0; i < keyLength; i = i + 2)
    {
        ...
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) = sCipherKey;
    }

    
    while(0x00 == ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) & (0x0002)))
    {
        ;
    }
    return(0x01);
                        ...
                        uint8_t * encryptedData)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~(0x0003);
    ...
    for(i = 0; i < 16; i = i + 2)
    {
        ...
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) = tempVariable;
    }

    
    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) |= (0x0002);

    
    while((0x0001) == ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) & (0x0001)))
    {
        ;
    }
    ...
    for(i = 0; i < 16; i = i + 2)
    {
        tempData = (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000A))));
                              ...
                              uint16_t keyLength)
{
    ...
    for(i = 0; i < keyLength; i = i + 2)
    {
        ...
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) = tempVariable;
    }

    
    while(((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) & (0x0001)) == (0x0001))
    {
        ;
    }
...
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~(0x0100);
}

uint32_t AES256_getInterruptStatus(uint16_t baseAddress)
{
    return (((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) & (0x0100)) << 0x04);
}

void AES256_enableInterrupt(uint16_t baseAddress)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x1000);
}
...
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x0080);
}
                          ...
                          uint8_t *outputData)
{
    ...
    if((0x0001) == ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) & (0x0001)))
    {
        return(0x00);
    }
...
{
    return ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) & (0x0001));
}
...
{
    return ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) & (0x0800));
}
