                      ...
                      uint8_t mode)
{
    ...
    uint8_t val = (*((volatile uint8_t *)((uint16_t)0x0158 + (0x0000)))) & ~(0x3 << sectorPos);

    (*((volatile uint16_t *)((uint16_t)0x0158 + (0x0000)))) = ((0x5a00) | val | (mode << sectorPos));
}

uint8_t RAM_getSectorState(uint8_t sector)
{
    uint8_t sectorPos = sector << 1;
    return(((*((volatile uint8_t *)((uint16_t)0x0158 + (0x0000)))) & (0x3 << sectorPos)) >> sectorPos);
}
