...
_Bool Comp_E_init(uint16_t baseAddress,
                 Comp_E_initParam *param)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= 0x0000;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000C)))) &= 0x0000;

    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) &= ~((0x00c0) | (0x6000));

    
    if((0x9F) != positiveTerminalInput)
    {
        
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x0080) + positiveTerminalInput;

        
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) |= (1 << positiveTerminalInput);
    }
    else
    {
        
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) &= ~((0x0020)); 
    }

    
    if((0x9F) != negativeTerminalInput)
    {
        
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x8000) + (negativeTerminalInput << 8);

        
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) |= (1 << negativeTerminalInput);
    }
    else
    {
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) =
        +param->outputFilterEnableAndDelayLevel  
...
void Comp_E_setReferenceVoltage(uint16_t baseAddress,
                                ...
                                uint16_t upperLimitSupplyVoltageFractionOf32)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) &= ~((0x1000)); 

    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) &= (0x0020);

    
    if(((0x0000)) == supplyVoltageReferenceBase)
    {
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) |= (0x0040); 
    }
    else if(lowerLimitSupplyVoltageFractionOf32 == 32)
    {
        ...
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) |= (0x00c0); 
    }
    else
    {
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) |= (0x0080); 
    }
...
void Comp_E_setReferenceAccuracy(uint16_t baseAddress,
                                 uint16_t referenceAccuracy)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) &= ~((0x8000));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) |= referenceAccuracy;
}

void Comp_E_setPowerMode(uint16_t baseAddress,
                         uint16_t powerMode)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) &= ~(((0x0100)) | ((0x0200)));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) |= powerMode;
}
                            ...
                            uint16_t interruptMask)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000C)))) |= interruptMask;
}
...
void Comp_E_clearInterrupt(uint16_t baseAddress,
                           uint16_t interruptFlagMask)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x000C)))) &= ~(interruptFlagMask);
}

uint8_t Comp_E_getInterruptStatus(uint16_t baseAddress,
                                  uint16_t interruptFlagMask)
{
    return ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x000C)))) & interruptFlagMask);
}
                                      ...
                                      uint16_t edgeDirection)
{
    ...
    if(((0x0008)) == edgeDirection)
    {
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) |= (0x0008);
    }
    else if((!((0x0008))) == edgeDirection)
    {
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) &= ~((0x0008));
    }
}
...
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) |= (0x0400);
}
...
void Comp_E_disableInputBuffer(uint16_t baseAddress,
                               uint16_t inputPort)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) |= (inputPort);
}
...
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) ^= (0x0020); 
}
