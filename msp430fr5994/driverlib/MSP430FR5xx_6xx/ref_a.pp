...
void Ref_A_setReferenceVoltage(uint16_t baseAddress,
                               uint8_t referenceVoltageSelect)
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)))) &= ~((0x0030));
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)))) |= referenceVoltageSelect;
}

void Ref_A_disableTempSensor(uint16_t baseAddress)
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x0008);
}
...
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x0001);
}
...
_Bool Ref_A_isBandgapActive(uint16_t baseAddress)
{
    if((*((volatile uint16_t *)((uint16_t)(baseAddress) + (0x0000)))) & (0x0200))
    {
        return (1);
    }
    else
...
{
    return ((*((volatile uint16_t *)((uint16_t)(baseAddress) + (0x0000)))) & (0x0400));
}

_Bool Ref_A_isRefGenActive(uint16_t baseAddress)
{
    if((*((volatile uint16_t *)((uint16_t)(baseAddress) + (0x0000)))) & (0x0100))
    {
        return (1);
    }
    else
...
_Bool Ref_A_isBufferedBandgapVoltageReady(uint16_t baseAddress)
{
    if((*((volatile uint16_t *)((uint16_t)(baseAddress) + (0x0000)))) & (0x2000))
    {
        return (1);
    }
    else
...
_Bool Ref_A_isVariableReferenceVoltageOutputReady(uint16_t baseAddress)
{
    if((*((volatile uint16_t *)((uint16_t)(baseAddress) + (0x0000)))) & (0x1000))
    {
        return (1);
    }
    else
...
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x0040);
}

void Ref_A_setBufferedBandgapVoltageOneTimeTrigger(uint16_t baseAddress)
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x0080);
}
