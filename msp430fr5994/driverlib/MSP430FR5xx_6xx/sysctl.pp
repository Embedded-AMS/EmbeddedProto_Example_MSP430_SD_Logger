...
{
    (*((volatile uint8_t *)((uint16_t)0x0180 + (0x0000)))) |= (0x0020);
}

uint8_t SysCtl_getBSLEntryIndication(void)
{
    if((*((volatile uint8_t *)((uint16_t)0x0180 + (0x0000)))) & (0x0010))
    {
        return ((0x1));
    }
    else
...
{
    (*((volatile uint8_t *)((uint16_t)0x0180 + (0x0000)))) |= (0x0004);
}

void SysCtl_enableRAMBasedInterruptVectors(void)
{
    (*((volatile uint8_t *)((uint16_t)0x0180 + (0x0000)))) |= (0x0001);
}
...
void SysCtl_initJTAGMailbox(uint8_t mailboxSizeSelect,
                            uint8_t autoClearInboxFlagSelect)
{
    (*((volatile uint8_t *)((uint16_t)0x0180 + (0x0006)))) &= ~((0x0080) + (0x0040) + (0x0010));
    (*((volatile uint8_t *)((uint16_t)0x0180 + (0x0006)))) |=
        mailboxSizeSelect + autoClearInboxFlagSelect;
}

uint8_t SysCtl_getJTAGMailboxFlagStatus(uint8_t mailboxFlagMask)
{
    return ((*((volatile uint8_t *)((uint16_t)0x0180 + (0x0006)))) & mailboxFlagMask);
}

void SysCtl_clearJTAGMailboxFlagStatus(uint8_t mailboxFlagMask)
{
    (*((volatile uint8_t *)((uint16_t)0x0180 + (0x0006)))) &= ~(mailboxFlagMask);
}

uint16_t SysCtl_getJTAGInboxMessage16Bit(uint8_t inboxSelect)
{
    return ((*((volatile uint16_t *)((uint16_t)0x0180 + (0x0008) + inboxSelect))));
}

uint32_t SysCtl_getJTAGInboxMessage32Bit(void)
{
    uint32_t JTAGInboxMessageLow = (*((volatile uint16_t *)((uint16_t)0x0180 + (0x0008))));
    uint32_t JTAGInboxMessageHigh = (*((volatile uint16_t *)((uint16_t)0x0180 + (0x000A))));
...
void SysCtl_setJTAGOutgoingMessage16Bit(uint8_t outboxSelect,
                                        uint16_t outgoingMessage)
{
    (*((volatile uint16_t *)((uint16_t)0x0180 + (0x000C) + outboxSelect))) = outgoingMessage;
}

void SysCtl_setJTAGOutgoingMessage32Bit(uint32_t outgoingMessage)
{
    (*((volatile uint16_t *)((uint16_t)0x0180 + (0x000C)))) = (outgoingMessage);
    (*((volatile uint16_t *)((uint16_t)0x0180 + (0x000E)))) = (outgoingMessage >> 16);
}
