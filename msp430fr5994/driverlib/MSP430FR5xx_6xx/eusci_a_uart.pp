...
_Bool EUSCI_A_UART_init(uint16_t baseAddress,
                       EUSCI_A_UART_initParam *param)
{
    _Bool retVal = 0x01;
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= param->selectClockSource;

    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~(0x2000);
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= param->msborLsbFirst;

    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~(0x0800);
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= param->numberofStopBits;
    ...
    case 0x00:
        ...
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~(0x8000);
        break;
    case 0x01:
        
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= (0x8000);
        (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~(0x4000);
        break;
    case 0x02:
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) = param->clockPrescalar;
    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008)))) = ((param->secondModReg << 8)
                                            + (param->firstModReg <<
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= param->uartMode;

    
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) &= ~((0x0020) + (0x0010) + (0x0008) +
                                              (0x0004) + (0x0002)
                                              );
    return (retVal);
}
                                  ...
                                  uint8_t mask)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x001A)))) |= locMask;

    locMask = (mask & ((0x0020)
                       | (0x0010)));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0000)))) |= locMask;
}
