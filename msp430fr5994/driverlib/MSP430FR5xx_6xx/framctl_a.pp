...
{
    uint8_t temp = (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0000))));

    
    (*((volatile uint16_t *)((uint16_t)0x0140 + (0x0000)))) = (0xa500) | temp;

    
    (*((volatile uint16_t *)((uint16_t)0x0140 + (0x0004)))) |= interruptMask;
}

uint8_t FRAMCtl_A_getInterruptStatus(uint16_t interruptFlagMask)
{
    return ((*((volatile uint16_t *)((uint16_t)0x0140 + (0x0006)))) & interruptFlagMask);
}
...
void FRAMCtl_A_clearInterrupt(uint16_t interruptFlagMask)
{
    ...
    (*((volatile uint16_t *)((uint16_t)0x0140 + (0x0006)))) &= ~interruptFlagMask;
}
...
void FRAMCtl_A_delayPowerUpFromLPM(uint8_t delayStatus)
{
    ...
    (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0004)))) &= ~(0x0004);
    (*((volatile uint8_t *)((uint16_t)0x0140 + (0x0004)))) |= delayStatus;
}
