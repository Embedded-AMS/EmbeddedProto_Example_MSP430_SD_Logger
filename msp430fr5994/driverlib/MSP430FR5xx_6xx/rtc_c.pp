...
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)+1))) = (0x00a5);
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0002)))) &= ~((0x0040));
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)+1))) = 0x00;
}
...
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)+1))) = (0x00a5);
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) &= ~((0x0300));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) |= frequencySelect;
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)+1))) = 0x00;
}
...
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)+1))) = (0x00a5);
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0004)))) = offsetValue + offsetDirection;
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)+1))) = 0x00;
}
                       ...
                       uint16_t counterSizeSelect)
{
    ...
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0002)))) |= (0x0040);
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0002)))) &= ~((0x0020));

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) &= ~((0x000c) | (0x0003));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) |= clockSelect + counterSizeSelect;
}

_Bool RTC_C_setTemperatureCompensation(uint16_t baseAddress,
                                      uint16_t offsetDirection,
                                      uint8_t offsetValue)
{
    while(!((*((volatile uint8_t *)((uint16_t)baseAddress + (0x0006)+1))) & (0x0040)))
    {
        ;
    }

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0006)))) = offsetValue + offsetDirection;

    if((*((volatile uint8_t *)((uint16_t)baseAddress + (0x0006)+1))) & (0x0020))
    {
        return(0x01);
    }
    else
                        ...
                        uint16_t formatSelect)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) &= ~((0x0080));
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) |= formatSelect;

    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0010)))) = CalendarTime->Seconds;
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0010)+1))) = CalendarTime->Minutes;
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0012)))) = CalendarTime->Hours;
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0012)+1))) = CalendarTime->DayOfWeek;
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0014)))) = CalendarTime->DayOfMonth;
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0014)+1))) = CalendarTime->Month;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0016)))) = CalendarTime->Year;
...
Calendar RTC_C_getCalendarTime(uint16_t baseAddress)
{
    ...
    while(!((*((volatile uint8_t *)((uint16_t)baseAddress + (0x0002)))) & (0x0010)))
    {
        ;
    }

    tempCal.Seconds = (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0010))));
    tempCal.Minutes = (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0010)+1)));
    tempCal.Hours = (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0012))));
    tempCal.DayOfWeek = (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0012)+1)));
    tempCal.DayOfMonth = (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0014))));
    tempCal.Month = (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0014)+1)));
    tempCal.Year = (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0016))));
                                  ...
                                  RTC_C_configureCalendarAlarmParam *param)
{
    ...
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0018)))) = (param->minutesAlarm ^ 0x80);
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0018)+1))) = (param->hoursAlarm ^ 0x80);
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x001A)))) = (param->dayOfWeekAlarm ^ 0x80);
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x001A)+1))) = (param->dayOfMonthAlarm ^ 0x80);
}
...
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)+1))) = (0x00a5);
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0002)))) &= ~((0x0003)); 
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0002)))) |= eventSelect;
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)+1))) = 0x00;
}

uint32_t RTC_C_getCounterValue(uint16_t baseAddress)
{
    if(((*((volatile uint8_t *)((uint16_t)baseAddress + (0x0002)))) & (0x0040))
       || ((*((volatile uint8_t *)((uint16_t)baseAddress + (0x000A)))) & (0x0100)))
    {
        return (0);
    }

    uint32_t counterValue_L = (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0010))));
    uint32_t counterValue_H = (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0012))));
...
void RTC_C_setCounterValue(uint16_t baseAddress,
                           uint32_t counterValue)
{
    uint16_t mode = (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0002)))) & (0x0003);

    if(mode == ((0x0000)) && counterValue > 0xF)
    {
        counterValue = 0xF;
    }
    else if(mode == ((0x0001)) && counterValue > 0xFF)
    {
        counterValue = 0xFF;
    }
    else if(mode == ((0x0002)) && counterValue > 0xFFFFFF)
    {
        counterValue = 0xFFFFFF;
    }

    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0010)))) = counterValue;
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0012)))) = (counterValue >> 16);
}
                               ...
                               uint16_t prescaleDivider)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x0008) + prescaleSelect))) =
...
void RTC_C_holdCounterPrescale(uint16_t baseAddress,
                               uint8_t prescaleSelect)
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0008)+1 + prescaleSelect))) |= (0x0001);
}
...
void RTC_C_definePrescaleEvent(uint16_t baseAddress,
                               ...
                               uint8_t prescaleEventDivider)
{
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0008) + prescaleSelect))) &= ~((0x001c));
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0008) + prescaleSelect))) |= prescaleEventDivider;
}

uint8_t RTC_C_getPrescaleValue(uint16_t baseAddress,
                               uint8_t prescaleSelect)
{
    if((0x0) == prescaleSelect)
    {
        return ((*((volatile uint8_t *)((uint16_t)baseAddress + (0x000C)))));
    }
    else if((0x2) == prescaleSelect)
    {
        return ((*((volatile uint8_t *)((uint16_t)baseAddress + (0x000C)+1))));
    }
    else
    {
        return (0);
                            ...
                            uint8_t prescaleCounterValue)
{
    ...
    if((0x0) == prescaleSelect)
    {
        (*((volatile uint8_t *)((uint16_t)baseAddress + (0x000C)))) = prescaleCounterValue;
    }
    else if((0x2) == prescaleSelect)
    {
        (*((volatile uint8_t *)((uint16_t)baseAddress + (0x000C)+1))) = prescaleCounterValue;
    }
    (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)+1))) = 0x00;
}
...
void RTC_C_enableInterrupt(uint16_t baseAddress,
                           uint8_t interruptMask)
{
    if(interruptMask & ((0x0080) + (0x0040) + (0x0020) + (0x0010)))
    {
        (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)+1))) = (0x00a5);
        (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)))) |=
            (interruptMask & ((0x0080) + (0x0040) + (0x0020) + (0x0010)));
        (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000)+1))) = 0x00;
    }

    if(interruptMask & 0x02)
    {
        (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0008)))) |= (0x0002);
    }

    if(interruptMask & 0x01)
    {
        (*((volatile uint8_t *)((uint16_t)baseAddress + (0x000A)))) |= (0x0002);
    }
}
                                 ...
                                 uint8_t interruptFlagMask)
{
    ...
    tempInterruptFlagMask |= ((*((volatile uint8_t *)((uint16_t)baseAddress + (0x0000))))
                              & ((interruptFlagMask >> 4)
                                 & ((0x0008) +
                                    (0x0004) +
                                    (0x0002) +
    ...
    if(interruptFlagMask & 0x02)
    {
        if((*((volatile uint8_t *)((uint16_t)baseAddress + (0x0008)))) & (0x0001))
        {
            tempInterruptFlagMask |= 0x02;
        }
    }

    if(interruptFlagMask & 0x01)
    {
        if((*((volatile uint8_t *)((uint16_t)baseAddress + (0x000A)))) & (0x0001))
        {
            tempInterruptFlagMask |= 0x01;
        }
    }
                          ...
                          uint8_t interruptFlagMask)
{
    ...
    if(interruptFlagMask & 0x02)
    {
        (*((volatile uint8_t *)((uint16_t)baseAddress + (0x0008)))) &= ~((0x0001));
    }

    if(interruptFlagMask & 0x01)
    {
        (*((volatile uint8_t *)((uint16_t)baseAddress + (0x000A)))) &= ~((0x0001));
    }
}
...
uint16_t RTC_C_convertBCDToBinary(uint16_t baseAddress,
                                  uint16_t valueToConvert)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x001E)))) = valueToConvert;
    return ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x001E)))));
}

uint16_t RTC_C_convertBinaryToBCD(uint16_t baseAddress,
                                  uint16_t valueToConvert)
{
    (*((volatile uint16_t *)((uint16_t)baseAddress + (0x001C)))) = valueToConvert;
    return ((*((volatile uint16_t *)((uint16_t)baseAddress + (0x001C)))));
}
