...
)
{
	...
	((arp) = (va_list)((long)__va_parmadr(str) + (__va_argref(str) ? sizeof(__builtin_addressof(str)) : (sizeof(str) < sizeof(int) ? sizeof(int) : sizeof(str)))));
	...
	for (cc = res = 0; cc != (-1); res += cc) {
		...
		switch (d) {				 
		case 'S' :					 
			p = (__va_argref(TCHAR*) ? ((arp += sizeof(TCHAR* *)), (* *(TCHAR* * *)(arp - sizeof(TCHAR* *)))) : ((arp += (((sizeof(TCHAR*)) + 1) & ~1)), (*(TCHAR* *)(arp - (((sizeof(TCHAR*)) + 1) & ~1)))));
			for (j = 0; p[j]; j++) ;
			res = 0;
			...
			continue;
		case 'C' :					 
			cc = f_putc((TCHAR)(__va_argref(int) ? ((arp += sizeof(int*)), (* *(int* *)(arp - sizeof(int *)))) : ((arp += (((sizeof(int)) + 1) & ~1)), (*(int*)(arp - (((sizeof(int)) + 1) & ~1))))), fil); continue;
		case 'B' :					 
			r = 2; break;
		case 'O' :					 
			r = 8; break;
		...
		v = (f & 4) ? (__va_argref(long) ? ((arp += sizeof(long*)), (* *(long* *)(arp - sizeof(long *)))) : ((arp += (((sizeof(long)) + 1) & ~1)), (*(long*)(arp - (((sizeof(long)) + 1) & ~1))))) : ((d == 'D') ? (long)(__va_argref(int) ? ((arp += sizeof(int*)), (* *(int* *)(arp - sizeof(int *)))) : ((arp += (((sizeof(int)) + 1) & ~1)), (*(int*)(arp - (((sizeof(int)) + 1) & ~1))))) : (__va_argref(unsigned int) ? ((arp += sizeof(unsigned int*)), (* *(unsigned int* *)(arp - sizeof(unsigned int *)))) : ((arp += (((sizeof(unsigned int)) + 1) & ~1)), (*(unsigned int*)(arp - (((sizeof(unsigned int)) + 1) & ~1))))));
		if (d == 'D' && (v & 0x80000000)) {
			v = 0 - v;
			f |= 8;
		}
