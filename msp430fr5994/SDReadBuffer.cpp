...
uint32_t SDReadBuffer::get_size() const
{
  return write_index_;
}

uint32_t SDReadBuffer::get_max_size() const
{
  return MAX_SIZE;
}

bool SDReadBuffer::peek(uint8_t& byte) const
{
...
uint8_t* SDReadBuffer::get_data_array()
{
  return data_;
}

uint32_t& SDReadBuffer::get_bytes_written()
{
  return write_index_;
}

void SDReadBuffer::clear()
{
  read_index_ = 0;
  write_index_ = 0;
}

bool SDReadBuffer::push(uint8_t& byte)
{
