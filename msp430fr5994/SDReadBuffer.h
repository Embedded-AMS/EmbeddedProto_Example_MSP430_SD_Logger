...
#ifndef INC_SDREADBUFFER_H_
#define INC_SDREADBUFFER_H_

#include <cstdint>
#include <ReadBufferInterface.h>

class SDReadBuffer : public ::EmbeddedProto::ReadBufferInterface
{
  ...
  private:
    ...
    //! The array in which the data received over SD is stored.
