...
def generate_source_code():
    ...
    print("Generate the source file based on sd_messages.proto.", end='')
    try:
        os.chdir("EmbeddedProto")
        
        command = ["protoc", "-I../proto", "--eams_out=../msp430fr5994/generated", 
                   "../proto/sd_messages.proto"]
        ...
        result = subprocess.run(["protoc", "-I./proto", "--python_out=./desktop/generated", 
                                 "./proto/sd_messages.proto"], check=False, capture_output=True)
        if result.returncode:
            print(" [" + CRED + "Fail" + CEND + "]")
            print(result.stderr.decode("utf-8"), end='', file=stderr)
            exit(1)
...
if __name__ == "__main__":
    ...
    if args.clean:
        ...
        try:
            os.remove("./desktop/generated/sd_messages_pb2.py")
